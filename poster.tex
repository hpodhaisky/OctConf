% Als A2 auf 4 A4-Blättern ausdrucken mit: 
% pdfposter -O 2 -S -p a2 poster.pdf out.pdf
%
...
{ 
	\vskip.5cm
	\parbox[bottom][][c]{\paperwidth} % ich gebe zu: Das ist alles ein bisschen zurechtgeschustert...
	{\centering
...
trees, \dots). You can download this poster from
\url{https://github.com/hpodhaisky/OctConf}.
